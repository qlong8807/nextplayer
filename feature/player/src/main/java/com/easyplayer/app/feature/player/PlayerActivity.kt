...
import com.easyplayer.app.core.common.extensions.getMediaContentUri
import com.easyplayer.app.core.ui.theme.EasyPlayerTheme
import com.easyplayer.app.core.common.service.registerForSuspendActivityResult
...
import com.easyplayer.app.feature.player.service.PlayerService
import com.easyplayer.app.feature.player.service.addSubtitleTrack
import com.easyplayer.app.feature.player.service.stopPlayerSession
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CompositionLocalProvider(LocalUseMaterialYouControls provides (uiState.playerPreferences?.useMaterialYouControls == true)) {
                EasyPlayerTheme(darkTheme = true) {
                    MediaPlayerScreen(
                        player = player,
                        viewModel = viewModel,
                        playerPreferences = uiState.playerPreferences ?: return@EasyPlayerTheme,
